...
const SearchBar = ({
  ...
  <View className="flex-row items-center bg-gray-100 dark:bg-gray-800 rounded-xl px-4" style={{ height: 52 }}>
      ...
      <TouchableWithoutFeedback onPress={handleDismissKeyboard}>
        <View style={{ flex: 1 }}>
          ...
          <View className="px-6 mb-8">
            ...
            {/* Daily Challenge - Prominent Card */}
            <TouchableOpacity
                  ...
                  <View className="flex-1">
                    <View className="flex-row items-center mb-2">
                      ...
                      <View>
                        ...
                        <Text style={{ color: '#f3e8ff' }} className="text-sm">
                          Test your knowledge!
                        </Text>
                      </View>
                    </View>
                    <Text style={{ color: 'rgba(255, 255, 255, 0.9)' }} className="text-base mt-2">
                      Take on fun challenges to improve your vocabulary
                    </Text>
                  </View>
                  <View className="ml-4">
                ...
                {totalPages > 0 && (
                  <View className="px-6 py-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 flex-row items-center justify-between">
                    <TouchableOpacity
                      ...
                      className={`px-5 py-3 rounded-lg ${searchPage === 1
                        ? 'bg-gray-100 dark:bg-gray-800'
                        : 'bg-primary-600'
                        }`}
                    >
                      <Text className={`text-base font-medium ${searchPage === 1
                        ? 'text-gray-400'
                        : 'text-white'
                        }`}>
                        Previous
                    ...
                    <TouchableOpacity
                      ...
                      className={`px-5 py-3 rounded-lg ${searchPage === totalPages
                        ? 'bg-gray-100 dark:bg-gray-800'
                        : 'bg-primary-600'
                        }`}
                    >
                      <Text className={`text-base font-medium ${searchPage === totalPages
                        ? 'text-gray-400'
                        : 'text-white'
                        }`}>
                        Next
